...
}();"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("mathematica",(()=>{"use strict"
...
begin:/[[\](){}]/}]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
},relevance:0}]})})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
},contains:[c]}]}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
begin:"[0-9]+[bf]"}],relevance:0}],illegal:/\//})})());hljs.registerLanguage("coffeescript",(()=>{"use strict"
...
n.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],n}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
